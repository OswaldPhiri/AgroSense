            ...
            <div className="w-full max-w-md">
                ...
                <div className="bg-slate-900/50 backdrop-blur-xl border border-white/5 p-8 rounded-3xl shadow-2xl">
                    <div className="mb-8">
                        ...
                        <p className="text-slate-400 text-sm">Sign in to your agricultural advisory dashboard.</p>
                    </div>
                ...
                <div className="mt-8 text-center bg-green-500/10 border border-green-500/20 p-4 rounded-2xl">
                    <p className="text-green-400 text-xs font-bold tracking-tight">
                        MVP DEMO CREDENTIALS:<br />
                        Email: <span className="text-white">admin@agrosense.ai</span> | Pass: <span className="text-white">password123</span>
                    </p>
                </div>
            </div>
        </div>
